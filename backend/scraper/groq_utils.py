...
async def extract_fields_from_job_link_with_groq(markdown, count):
    try:
        ...
        prompt = (
            ...
            "- 'description': Extract a short summary (1–3 sentences) of what the role is about. Focus on the mission, purpose, or scope of the role. Use exact sentences from the job posting — do not paraphrase, summarize, or alter the text in any way."
            ...
            "- 'work_model': Choose one of: 'Hybrid', 'On-site', or 'Remote'. Return 'Remote' only if clearly stated using phrases like 'remote' and 'work remotely'."
            "Return 'Hybrid' if the post contains terms like 'WFH', 'flexible work', 'flexibility to work from home', 'at least X days in office' or other similar phrases that mention splitting time between office and home."
            "If there is no clear mention of remote or hybrid work, return 'On-site' by default. Never return None.\n"
