VALID_JSON_STRING = """{
    "description": "This is an amazing opportunity for someone looking to take the next step in their \
    product development career within a well-loved retail brand.",
    "responsibilities": [
        "Support the development of Dymocks' exclusive gifting range, from concept to launch.",
        "Work with suppliers to manage production timelines, negotiate terms, and maintain quality \
        control.",
...
MALFORMED_JSON_STRING = """{
    Here is the extracted job posting data in a valid JSON object:
    {
        "description": "This innovative tech business is expanding its engineering function and seeking a Site \
        Reliability Engineer to help ensure their world-class platform continues to run like clockwork.",
        "responsibilities": [
